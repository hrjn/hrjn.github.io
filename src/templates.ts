...
const site_url = "https://hrjn.github.io";
...
<head>
  ...
  <link rel="alternate" type="application/rss+xml" title="hrjn" href="${site_url}/feed.xml">
...
const blurb = "Yet another programming blog by Harizo Rajaona aka hrjn.";
